...
build-dev-deps:
	docker build -t stellar-core:protocol19 -f docker/Dockerfile.testing https://github.com/stellar/stellar-core.git#v19.0.0rc1 --build-arg BUILDKIT_CONTEXT_KEEP_GIT_DIR=true --build-arg CFLAGS='' --build-arg CXXFLAGS='-stdlib=libc++' --build-arg CONFIGURE_FLAGS='--disable-tests --enable-next-protocol-version-unsafe-for-production'
